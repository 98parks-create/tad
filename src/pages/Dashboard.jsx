          ...
          <>
            ...
            <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '1px solid #e2e8f0' }}>
              ...
              <ul style={{ color: 'var(--text-light)', lineHeight: '1.8', paddingLeft: '1.5rem', marginBottom: '2rem' }}>
                <li><span className="guide-sidebar-text">좌측 메뉴의 </span><span className="guide-bottomnav-text">하단 탭의 </span><strong>[새 견적 작성]</strong>을 통해 고객 정보 및 자재 규격을 입력하면 견적 금액이 자동 산출됩니다.</li>
